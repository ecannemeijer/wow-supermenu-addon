...
local function CreateMainFrame()
    ...
    -- Calculate height: 5 buttons * 28px + 4 gaps * 8px + top margin (55) + bottom margin (16)
    local numButtons = 5
    ...
    guildBtn:SetPoint("TOP", statsBtn, "BOTTOM", 0, -8)

    -- Custom Action Bar 1 Keybinding Menu
    local keybindFrame
    local function ShowKeybindMenu()
    ...
    local button3 = CreateFancyButton(mainFrame, "Key Bindings", 160, 28, ShowKeybindMenu)
    button3:SetPoint("TOP", guildBtn, "BOTTOM", 0, -8)


    -- Dungeon Lockouts window
    local dungeonFrame
    local function ShowDungeonWindow()
    ...
    local button4 = CreateFancyButton(mainFrame, "Dungeon Lockouts", 160, 28, ShowDungeonWindow)
    button4:SetPoint("TOP", button3, "BOTTOM", 0, -8)

    -- Reload UI button (now last)
